...
#define RV_INSN_BASE(_name, op_maj, funct3, funct7, funct12, encoding) \
...
#define RV_INSN_ALU(_name, op_maj, funct3, funct7, is_ri) \
    RV_INSN_BASE(_name, op_maj, funct3, funct7, 0, is_ri ? RV_ENC_I : RV_ENC_R) 

// Define a register-immediate ALU instruction.
#define RV_INSN_ALU_RI(name, op_maj, funct3, funct7) \
    RV_INSN_ALU(name, op_maj, funct3, 0, 1)

// Define a register-register ALU instruction.
#define RV_INSN_ALU_RR(name, op_maj, funct3, funct7) \
    RV_INSN_ALU(name, op_maj, funct3, funct7, 0)

// Define a branch instruction.
#define RV_INSN_BRANCH(_name, op_maj, funct3) \
    RV_INSN_BASE(_name, op_maj, funct3, 0, 0, RV_ENC_B)

// Define a store instruction.
#define RV_INSN_STORE(_name, op_maj, funct3) \
    RV_INSN_BASE(_name, op_maj, funct3, 0, 0, RV_ENC_S)

// Define a load instruction.
#define RV_INSN_LOAD(_name, op_maj, funct3) \
    RV_INSN_BASE(_name, op_maj, funct3, 0, 0, RV_ENC_I)
